using DrugsoreManagement.BackendApi.Constants;
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo 
        { Title="Swagger DrugstoreManagement", Version="v1"});
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger DrugstoreManagement V1");
});
